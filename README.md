...
| <a name="input_protect"></a> [protect](#input\_protect) | A flage that allows to delete compartments with terraform destroy. This setting should only be changed by experienced users. | `bool` | `false` | no |
